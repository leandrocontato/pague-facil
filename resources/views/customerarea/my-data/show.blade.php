            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                {!!Form::model($my_data, ['method' => 'put', 'autocomplete' => false, 'route' => ['customerarea-my-data', $my_data->customer_id, http_build_query(Request::input())], 'class' => ($errors->any()) ? 'was-validated': '' ,'novalidate'])!!}               
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="my-2 col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                                    ...
                                                    {!!Form::select('countrie_id', [],  null, ['placeholder' => 'Selecione', 'class' => 'form-control',  'required', 'disabled'=> true, 'data-active' => (isset($my_data)) ? $my_data->countrie_id : old('countrie_id')])!!}
                                                ...
                                                <div class="my-2 col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                                    ...
                                                    {!!Form::select('state_id', [],  null, ['placeholder' => 'Selecione', 'class' => 'form-control',  'required', 'disabled'=> true, 'data-active' => (isset($my_data)) ? $my_data->state_id : old('state_id')])!!}
                                                ...
                                                <div class="my-2 col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                                    ...
                                                    {!!Form::select('citie_id', [],  null, ['placeholder' => 'Selecione', 'class' => 'form-control',  'required', 'disabled'=> true, 'data-active' => (isset($my_data)) ? $my_data->citie_id : old('citie_id') ])!!}
